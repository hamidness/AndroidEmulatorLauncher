...
export const runCommand = async (command: string, log?: (text: string) => void): Promise<undefined> => {
...
export const runSudoCommand = (command: string, log?: (text: string) => void): Promise<undefined> => {
